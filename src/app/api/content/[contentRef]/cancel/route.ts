...
import { cancelContent } from "@/server/content/content-lifecycle-service";
...
// POST /api/content/[contentRef]/cancel {reason, expectedVersion}
export async function POST(request: Request, { params }: RouteParams) {
  ...
  const result = await cancelContent(actor, contentRef, body, newRequestId());
