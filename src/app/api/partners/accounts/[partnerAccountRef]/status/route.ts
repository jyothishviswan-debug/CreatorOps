...
import { setPartnerAccountStatus } from "@/server/partners/partner-account-service";
...
export async function POST(request: Request, { params }: RouteParams) {
  ...
  const result = await setPartnerAccountStatus(actor, partnerAccountRef, body, newRequestId());
