...
import { saveAssetDecision } from "@/server/discovery/lead-service";
...
// POST /api/discovery/leads/[leadRef]/asset-decision
export async function POST(request: Request, { params }: RouteParams) {
  ...
  const result = await saveAssetDecision(actor, leadRef, body, newRequestId());
