...
import { saveResearch } from "@/server/discovery/lead-service";
...
// POST /api/discovery/leads/[leadRef]/research
export async function POST(request: Request, { params }: RouteParams) {
  ...
  const result = await saveResearch(actor, leadRef, body, newRequestId());
