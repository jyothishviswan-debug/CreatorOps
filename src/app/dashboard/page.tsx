...
export default function DashboardPage() {
  return (
    <AppShell crumb="Dashboard">
      ...
      <OverviewKpiRow
        items={[
          { icon: "users", label: "Active partners", value: "126", hint: "of 142 partners" },
          { icon: "brief", label: "Active campaigns", value: "18", hint: "across your portfolio" },
          { icon: "flag", label: "Content completed", value: "128", hint: "of 164 required" },
          { icon: "chart", label: "Needs attention", value: "11", hint: "actionable groups" },
        ]}
      />
      ...
      <OverviewRow>
        ...
        >
          <AttentionRows
            items={[
              { icon: "alert", title: "Overdue deliverables", hint: "Review", count: "8" },
              { icon: "brief", title: "Awaiting approval", hint: "Review", count: "6" },
              { icon: "search", title: "Discovery follow-ups", hint: "Contact", count: "3" },
              { icon: "flag", title: "Unstaffed campaign", hint: "Assign", count: "1" },
            ]}
          />
        </OverviewPanel>
        ...
        >
          <Events
            items={[
              { icon: "check", title: "Campaign content approved", detail: "Civic Voices · 12 min ago" },
              { icon: "users", title: "Partner profile completed", detail: "Nila Talks · 35 min ago" },
              { icon: "wallet", title: "Invoice review requested", detail: "Creator House · 1 hour ago" },
              { icon: "search", title: "Discovery lead converted", detail: "South Lens · 3 hours ago" },
            ]}
          />
        </OverviewPanel>

        <OverviewPanel span={3} icon="grid" tone={2} title="Quick Actions" foot="Actions preview the destination; no records are changed.">
          <ActionGrid
            actions={[
