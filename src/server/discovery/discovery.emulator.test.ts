    ...
    it("saving KYC never puts raw values into the append-only event log", async () => {
      ...
      const saved = await saveLeadKyc(
        ...
        created.data.leadRef,
        {
          ...
          aadhaar: { number: "1111-2222-3333", evidenceRef: "ref://a" },
          pan: { number: "SECRET1234F", evidenceRef: "ref://p" },
          bank: { accountHolderName: "Secret Name", accountNumber: "999999999999", ifsc: "SECR0000001", bankName: "Secret Bank", proofRef: "ref://b" },
