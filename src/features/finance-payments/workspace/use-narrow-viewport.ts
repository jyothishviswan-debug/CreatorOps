...
// Server / hydration snapshot: NOT KNOWN (null). The list renders a neutral placeholder for that
// first frame instead of guessing (a guessed table on a phone, then cards, is a visible flash).
