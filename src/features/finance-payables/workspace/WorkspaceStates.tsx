...
// Step 15B: the two whole-workspace fallback states, rendered by the server page INSTEAD of the workspace
// (the client workspace only ever renders for an authorized, successful read - nothing revealed then hidden).
